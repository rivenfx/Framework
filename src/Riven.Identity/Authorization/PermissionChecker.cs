...
namespace Riven.Authorization
{
    ...
    {
        protected readonly ICurrentUser _aspNetCoreSession;
        protected readonly IIdentityUserRoleFinder _userRoleFinder;
        protected readonly IIdentityPermissionFinder _permissionFinder;

        public PermissionChecker(ICurrentUser aspNetCoreSession, IIdentityUserRoleFinder userRoleFinder, IIdentityPermissionFinder permissionFinder)
        {
            _aspNetCoreSession = aspNetCoreSession;
        ...
        {
            return await this._permissionFinder.FindPermissions(IdentityPermissionType.User, userId);
        }
