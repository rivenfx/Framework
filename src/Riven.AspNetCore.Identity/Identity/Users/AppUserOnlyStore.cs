...
namespace Riven.Identity.Users
{
    ...
    public class AppUserOnlyStore<TUser> : AppUserOnlyStore<TUser, DbContext, string> where TUser : IdentityUser<string>, new()
    {
        /// <summary>
        /// Constructs a new instance of <see cref="AppUserOnlyStore{TUser}"/>.
        /// </summary>
        /// <param name="context">The <see cref="DbContext"/>.</param>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public AppUserOnlyStore(IdentityErrorDescriber describer = null) : base(describer) { }
    }
    ...
    public class AppUserOnlyStore<TUser, TContext> : AppUserOnlyStore<TUser, TContext, string>
    ...
    public class AppUserOnlyStore<TUser, TContext, TKey> : AppUserOnlyStore<TUser, TContext, TKey, IdentityUserClaim<TKey>, IdentityUserLogin<TKey>, IdentityUserToken<TKey>>
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// </summary>
        /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
        public AppUserOnlyStore(IdentityErrorDescriber describer = null)
            : base(describer) { }
    }
        ...
        where TUserToken : IdentityUserToken<TKey>, new()
    {
        ...
        public AppUserOnlyStore(IdentityErrorDescriber describer = null) : base(describer ?? new IdentityErrorDescriber())
        {
